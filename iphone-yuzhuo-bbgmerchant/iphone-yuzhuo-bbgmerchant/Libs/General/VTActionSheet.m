...
//    NSArray *_buttonTitles;
     ...
     * 代理 
     */
    id<VTActionSheetDelegate> _delegate;
...
@implementation VTActionSheet

+ (instancetype)sheetWithTitle:(NSString *)title buttonTitles:(NSArray *)titles redButtonIndex:(NSInteger)buttonIndex delegate:(id<VTActionSheetDelegate>)delegate {
